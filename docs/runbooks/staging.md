...
> Archived on 2026-09-06. Staging is no longer deployable. The populated D1 and
> R2 resources were promoted in place to Cloudflare production. Do not repeat
> the backfill. All current operations follow
> `docs/runbooks/production_candidate.md`.
